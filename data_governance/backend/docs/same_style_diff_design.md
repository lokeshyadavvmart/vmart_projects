# 🟦 Same Style Diff Design API – Frontend Documentation

**Endpoint:** `POST /api/same-style-diff-design/`

**Purpose:** Fetch records from the `same_style_diff_design` table with optional filters, date range, and infinite scroll support.
...
```
site_code, icode, po_number, design_no, color_or_style, vendor, division, section, department,
...
| `distinct_values` | object          | Unique values in the response for `site_code`, `division`, `section`, `department`, `vendor`, and `color_or_style`. |

### 2.1 Example Response

```json
{
  "columns": ["group_id","site_code","icode","po_number","design_no","color_or_style",
  ...
  "data": [
    [1656,101486,"VM3079336","PO084011-0326PWL","SS26-RAJ-39A","Blue",
     "2026-03-12","2026-03-01","Rajul Textiles : 0022798","Women Western","Western Sets","Coordinate Set-W [L]",
     "1 N","LIMEROAD","SOLID","WALL : POLKA","91cm/M","BLUE",
     "RAYON SLUB","399","ROUND NECK","REGULAR FIT","SHORT SLEEVES","REGULAR SLEEVES",
     "CASUAL","PLAIN","ALL OVER",5]
  ],
  "count": 2,
