// src/app/processes/duplicate_items/components/FilterPanel.tsx
    ...
    return (
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md border border-gray-100/80 p-3 transition-all">
            ...
            <div className="flex items-center justify-between">
                ...
                >
                    <svg
                        className={`w-4 h-4 text-blue-500 transition-transform duration-200 ${isExpanded ? 'rotate-90' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    >
                ...
                <div className="flex items-center space-x-2">
                    {activeFilterCount > 0 && (
                        <span className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-[10px] font-semibold px-2 py-0.5 rounded-full shadow-sm">
                            {activeFilterCount}
                        </span>
                    )}
                    <button
            ...
            {isExpanded && (
                <div className="mt-2 space-y-2">
                    ...
                    <div className="flex flex-wrap items-center gap-1">
                        <div className="flex items-center gap-1">
                            <input
                                ...
                                className="w-32 rounded border-gray-200 bg-gray-50/80 px-2 py-1 text-xs text-gray-700 focus:border-blue-400 focus:ring-1 focus:ring-blue-100"
                                placeholder="From"
                                suppressHydrationWarning
                            />
                            ...
                            return (
                                <div key={key} className="relative">
                                    <select
                                        ...
                                        className="w-full rounded border-gray-200 bg-gray-50/80 pl-2 pr-6 py-1 text-xs text-gray-700 focus:border-blue-400 focus:ring-1 focus:ring-blue-100 appearance-none truncate"
                                        title={label}
                                        suppressHydrationWarning
                                    >
                    ...
                    <div className="flex justify-end">
                        <button
                            onClick={handleApply}
                            className="px-4 py-1 text-xs font-medium text-white bg-gradient-to-r from-blue-500 to-indigo-500 rounded hover:from-blue-600 hover:to-indigo-600 focus:ring-1 focus:ring-blue-300 shadow-sm"
                            suppressHydrationWarning
                        >
                            Apply
                        </button>
