// src/app/processes/same_style_diff_design/components/FilterPanel.tsx
...
const FILTER_FIELDS: { key: keyof Filters; label: string }[] = [
    ...
    { key: 'color_or_style', label: 'Color / Style' },
];
    ...
    return (
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md border border-gray-100/80 p-3 transition-all">
            ...
            <div className="flex items-center justify-between">
                ...
                >
                    <svg
                        className={`w-4 h-4 text-teal-500 transition-transform duration-200 ${isExpanded ? 'rotate-90' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    >
                ...
                <div className="flex items-center space-x-2">
                    {activeFilterCount > 0 && (
                        <span className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white text-[10px] font-semibold px-2 py-0.5 rounded-full shadow-sm">
                            {activeFilterCount}
                        </span>
                    )}
                    <button
            ...
            {isExpanded && (
                <div className="mt-2 space-y-2">
                    ...
                    <div className="flex flex-wrap items-center gap-1">
                        <div className="flex items-center gap-1">
                            <input
                                ...
                                className="w-32 rounded border-gray-200 bg-gray-50/80 px-2 py-1 text-xs text-gray-700 focus:border-teal-400 focus:ring-1 focus:ring-teal-100"
                                placeholder="From"
                                suppressHydrationWarning
                            />
                    ...
                    {/* Filter dropdowns – compact grid (6 columns for 6 fields) */}
                            ...
                            return (
                                <div key={key} className="relative">
                                    <select
                                        ...
                                        className="w-full rounded border-gray-200 bg-gray-50/80 pl-2 pr-6 py-1 text-xs text-gray-700 focus:border-teal-400 focus:ring-1 focus:ring-teal-100 appearance-none truncate"
                                        title={label}
                                        suppressHydrationWarning
                                    >
                    ...
                    <div className="flex justify-end">
                        <button
                            onClick={handleApply}
                            className="px-4 py-1 text-xs font-medium text-white bg-gradient-to-r from-teal-500 to-cyan-500 rounded hover:from-teal-600 hover:to-cyan-600 focus:ring-1 focus:ring-teal-300 shadow-sm"
                            suppressHydrationWarning
                        >
                            Apply
                        </button>
